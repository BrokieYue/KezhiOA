$(function () {
    document.body.className = "theme-daicen-red"//localStorage.getItem('config-skin');
...
$.fn.jqGridRowValue = function () {
    ...
    if (selectedRowIds != "") {
        ...
        if (!!selectedRowId) {
            json = $grid.jqGrid('getRowData', selectedRowId);
        }
    }
    return json;
}
$.fn.jqGridRowValueNew = function (Type) {
